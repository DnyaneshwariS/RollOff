...
namespace ROLL_OFF_API.Models
{
    public partial class MydataContext : DbContext
    {
        ...
        public virtual DbSet<Rddb> Rddbs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LIN13003746\\SQLEXPRESS; Database=Mydata;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Rddb>(entity =>
            {
                entity.HasKey(e => e.GlobalGroupId)
                    .HasName("PK__RDDB__A8B3AC1AC37D850D");
